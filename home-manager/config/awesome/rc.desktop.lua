...
-- Desktop mode - no battery widget needed
...
awful.screen.connect_for_each_screen(function(s)
	...
	s.mywibox:setup({
		...
		nil,
		{
			...
			-- Desktop mode - no battery widget
		},
	})
end)
-- }}}
...
globalkeys = gears.table.join(
	...
	awful.key({ modkey }, "r", function()
		awful.spawn.with_shell("rofi -show drun -theme " .. drun_theme)
	...
	end, { description = "open default explorer", group = "launcher" }),

	awful.key({ modkey, "Shift" }, "c", function()
		awful.spawn.with_shell("neovide ~/.config/awesome/rc.lua")
	...
	awful.key({ modkey, "Shift" }, "q", function()
		awful.spawn.with_shell(powermenu_command)
	...
	awful.key({ modkey, "Shift" }, "w", function()
		awful.spawn.with_shell("~/scripts/window_switcher.sh")
	...
	-- Desktop mode - no brightness controls needed
